    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?= base_url('mata_pelajaran') ?>">Mata Pelajaran</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseFour" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Sub-Menu Akademik</h6>
            <a class="collapse-item" href="<?= base_url('nilai') ?>">Dashboard Nilai</a>
            <a class="collapse-item" href="<?= base_url('nilai/daftar_nilai') ?>">Data Nilai Siswa</a>
            <a class="collapse-item" href="<?= base_url('nilai/input_nilai') ?>">Input Nilai Siswa</a>
          </div>
        </div>
      </li>
